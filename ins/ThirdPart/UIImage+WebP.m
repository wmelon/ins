...
+ (UIImage *)imageWithWebP:(NSString *)filePath error:(NSError **)error
{
    ...
    return [UIImage sd_imageWithWebPData:imgData error:error];
}

+ (UIImage *)sd_imageWithWebPData:(NSData *)imgData error:(NSError **)error
{
...
+ (UIImage *)sd_imageWithWebPData:(NSData *)imgData
{
    NSParameterAssert(imgData != nil);
    return [self sd_imageWithWebPData:imgData error:nil];
}
